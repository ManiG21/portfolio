   ...
   return (
    <div className="about container">
        ...
        <header>About Me</header>  
         ...
         <div className='para'> <h2 id='ab'>Personal Interests/Hobbies</h2> 
        <div className='row'> <img className='logo'id='Chick' src={Chicken} alt='Chicken'></img>
